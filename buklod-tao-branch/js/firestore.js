...
function showModal(partner) {
	...
	// const modalResidencyStatus = document.getElementById(
	// 	'entry_residency_status'
	// );
	// const modalHOA = document.getElementById('entry_HOA/NOA');
	// const modalEvacArea = document.getElementById(
	// 	'entry_nearest_evacuation_area'
	// );
	// const modalEarthquakeRL = document.getElementById(
	// 	'entry_earthquake_risk_level'
	// );
	// const modalEarthquakeDesc = document.getElementById(
	// 	'entry_earthquake_desc'
	// );
	...
	// const modalLandslideRL = document.getElementById(
	// 	'entry_landslide_risk_level'
	// );
	...
	// const modalMinor = document.getElementById(
	// 	'entry_number_of_minor_residents'
	// );
	// const modalSenior = document.getElementById(
	// 	'entry_number_of_senior_residents'
	// );
	// const modalPWD = document.getElementById('entry_number_of_pwd_residents');
	// const modalSick = document.getElementById(
	// 	'entry_number_of_sick_residents'
	// );
	// const modalPregnant = document.getElementById(
	// 	'entry_number_of_pregnant_residents'
	// );
	...
	openEditForm.onclick = function () {
		...
		modal.style.display = 'none';
		document.getElementById('edit_household_name').value =
			partner.household_name;
		document.getElementById('edit_address').value =
			partner.household_address;
		document.getElementById('edit_contact_number').value =
			partner.contact_number;
		document.getElementById('edit_residency_status').value =
			partner.residency_status;
		document.getElementById('edit_HOA/NOA').value = partner.is_hoa_noa;
		document.getElementById('edit_nearest_evacuation_area').value =
			partner.nearest_evac;
		document.getElementById('edit_number_of_residents').value =
			partner.number_residents;
		document.getElementById('edit_number_of_minor_residents').value =
			partner.number_minors;
		document.getElementById('edit_number_of_senior_residents').value =
			partner.number_seniors;
		document.getElementById('edit_number_of_pwd_residents').value =
			partner.number_pwd;
		document.getElementById('edit_number_of_sick_residents').value =
			partner.number_sick;
		document.getElementById('edit_number_of_pregnant_residents').value =
			partner.number_pregnant;
