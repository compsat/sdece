...
export function showModal(partner) {
	...
	console.log('Partner being shown as modal: ' + partner.partner_name);
	...
	nameDiv.textContent = partner.partner_name.substring(0, 30) + '...';
	addressDiv.textContent =
		'Latitude, Longitude: ' +
		partner.partner_coordinates._lat +
		', ' +
		partner.partner_coordinates._long;
	...
	if (partner.length > 0) {
		...
		partner.forEach((activity) => {
			...
			activityNameDiv.innerHTML = partner.activity_nature + '';
	...
	admuContactDiv.innerHTML =
		'<b>AdMU Contact: </b>' + partner.ADMU_contact;
